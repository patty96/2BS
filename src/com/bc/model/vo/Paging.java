...
public class Paging {
	...
	private int numPerSearchPage = 10; //하나의 페이지에 표시할 게시글 수
	private int pagePerSearchBlock = 5; //블록당 표시하는 페이지 갯수
	...
	public void setTotalSearchPage() {
		totalSearchPage = totalRecord / numPerSearchPage;
		if (totalRecord % numPerSearchPage > 0) totalSearchPage++;
	}
	...
	public int getNumPerSearchPage() {
		return numPerSearchPage;
	}

	public void setNumPerSearchPage(int numPerSearchPage) {
		this.numPerSearchPage = numPerSearchPage;
	}

	public int getPagePerSearchBlock() {
		return pagePerSearchBlock;
	}

	public void setPagePerSearchBlock(int pagePerSearchBlock) {
		this.pagePerSearchBlock = pagePerSearchBlock;
	}
